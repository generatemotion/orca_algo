...
Summary Mission::StartMission() {
	...
	do {
		...
		needToStopBySpeed = (stopByMeanSpeed && allStops);
		needToStopByTime = (isTimeBounded && nowtime >= timeTreshhold);
		needToStopBySteps = (!isTimeBounded && stepsCount >= stepsTreshhold);
		needToStop = needToStopBySpeed || needToStopByTime || needToStopBySteps;
